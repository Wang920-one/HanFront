    ...
    <el-container>
      <el-main id="bgImg">
        ...
        <template>
          ...
          >
            <el-tab-pane label="汉服历史" name="first">
              <el-container>
                <el-main>
                  <el-timeline>
                    <el-timeline-item
                    ...
                    <el-timeline-item timestamp="前206年-220年" placement="top">
                      <el-card style="background-color:#ffffff70">
                    ...
                    <el-timeline-item timestamp="220年-589年" placement="top">
                      <el-card style="background-color:#ffffff70">
                    ...
                    <el-timeline-item timestamp="589年-960年" placement="top">
                      <el-card style="background-color:#ffffff70">
                        <h4>隋唐汉服（589年左右）</h4>
                        <p>
                    ...
                    <el-timeline-item timestamp="960-1279年" placement="top">
                      <el-card style="background-color:#ffffff70">
                        <h4>宋代汉服（960年左右）</h4>
                        <p>
                    ...
                    <el-timeline-item timestamp="1368年-1644年" placement="top">
                      <el-card style="background-color:#ffffff70">
                        <h4>明代汉服（1368年左右）</h4>
                        <p>
            ...
            <el-tab-pane label="汉服形制" name="second">
              <el-tabs
            ...
            <el-tab-pane label="汉服周边" name="third">
              <el-tabs
                :tab-position="tabPosition"
              ...
              >
                ...
                <el-tab-pane label="饰品">
                  <el-tabs
                    ...
                    style="font-family:'楷体';font-size:20px;"
                  >
                    <el-tab-pane label="腰带" name="third11"> </el-tab-pane>
                    <el-tab-pane label="披帛" name="third12"
                      >深衣制</el-tab-pane
                    >
                    <el-tab-pane label="首饰" name="third13"
                      >袍服制</el-tab-pane
                    >
                    <el-tab-pane label="其他" name="third14"
                      >袍服制</el-tab-pane
                    >
                  </el-tabs>
                </el-tab-pane>
                <el-tab-pane label="首服">
                  <el-tabs
                    ...
                    style="font-family:'楷体';font-size:20px;"
                  >
                    <el-tab-pane label="冠冕类" name="third21"> </el-tab-pane>
                    <el-tab-pane label="巾帽类" name="third22"
                      >深衣制</el-tab-pane
                    >
                    <el-tab-pane label="足衣" name="third23"
                      >袍服制</el-tab-pane
                    >
                    <el-tab-pane label="鞋" name="third24">袍服制</el-tab-pane>
                    <el-tab-pane label="靴" name="third25">袍服制</el-tab-pane>
                    <el-tab-pane label="袜" name="third26">袍服制</el-tab-pane>
                    <el-tab-pane label="其他" name="third27"
                      >袍服制</el-tab-pane
                    >
                  </el-tabs>
                </el-tab-pane>
                <el-tab-pane label="道具">
                  <el-tabs
                    ...
                    style="font-family:'楷体';font-size:20px;"
                  >
                    <el-tab-pane label="油纸伞" name="third31"> </el-tab-pane>
                    <el-tab-pane label="扇子" name="third32"
                      >深衣制</el-tab-pane
                    >
                    <el-tab-pane label="斗笠" name="third33"
                      >袍服制</el-tab-pane
                    >
                    <el-tab-pane label="弓箭" name="third34"
                      >袍服制</el-tab-pane
                    >
                  </el-tabs>
                </el-tab-pane>
            ...
            <el-tab-pane label="相关文化" name="fourth">
              <el-tabs
                :tab-position="tabPosition"
              ...
              >
                ...
                <el-tab-pane label="少数民族服装">
                  <el-tabs
                    ...
                    style="font-family:'楷体';font-size:20px;"
                  >
                    <el-tab-pane label="蒙古族" name="third41">
                      蒙古族</el-tab-pane
                    >
                    <el-tab-pane label="回族" name="third42">回族</el-tab-pane>
                    <el-tab-pane label="藏族" name="third43">藏族</el-tab-pane>
                    <el-tab-pane label="维吾尔族" name="third44"
                      >维吾尔族</el-tab-pane
                    >
                    <el-tab-pane label="苗族" name="third45">苗族</el-tab-pane>
                    <el-tab-pane label="彝族" name="third46">彝族</el-tab-pane>
                    <el-tab-pane label="壮族" name="third47">壮族</el-tab-pane>
                    <el-tab-pane label="满族" name="third50">满族</el-tab-pane>
                  </el-tabs>
                </el-tab-pane>
                <el-tab-pane label="少数民族服装1">
                  <el-tabs
                    ...
                    style="font-family:'楷体';font-size:20px;"
                  >
                    <el-tab-pane label="侗族" name="third51">侗族</el-tab-pane>
                    <el-tab-pane label="瑶族" name="third52">瑶族</el-tab-pane>
                    <el-tab-pane label="白族" name="third53">白族</el-tab-pane>
                    <el-tab-pane label="土家族" name="third54"
                      >土家族</el-tab-pane
                    >
                    <el-tab-pane label="哈尼族" name="third55"
                      >哈尼族</el-tab-pane
                    >
                    <el-tab-pane label="哈萨克族" name="third56"
                      >哈萨克族</el-tab-pane
                    >
                    <el-tab-pane label="黎族" name="third57"
                      >黎族、</el-tab-pane
                    >
                  </el-tabs>
                </el-tab-pane>
