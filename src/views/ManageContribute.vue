<template>
  <el-tabs type="border-card" v-model="activeName">
    <el-tab-pane label="专栏投稿" name="article">
      <div class="table">
        <div class="container">
          ...
          <el-table-column label="封面" width="110" align="center">
            <template slot-scope="scope">
              <div class="article-img">
                <img :src="getUrl(scope.row.actImg)" style="width:100%" />
              </div>
            </template>
          </el-table-column>
          <el-table-column
          ...
          <el-table-column label="操作" width="150" align="center">
            <template slot-scope="scope">
              ...
              <el-button
                size="mini"
                type="danger"
                @click="handleDelete(scope.row.atcId)"
                >删除</el-button
              >
            </template>
          </el-table-column>
        ...
        <div class="pagination">
          <el-pagination
            ...
            @current-change1="handleCurrentChange1"
          ></el-pagination>
        </div>
    ...
    <el-tab-pane label="视频投稿" name="video">
        ...
        >
          ...
          <el-table-column label="封面" width="110" align="center">
            <template slot-scope="scope">
              <div class="video-img">
                <img :src="getUrl(scope.row.videoImg)" style="width:100%" />
              </div>
            </template>
          </el-table-column>
          <el-table-column
          ...
          <el-table-column label="操作" width="150" align="center">
            <template slot-scope="scope">
              ...
              <el-button
                size="mini"
                type="danger"
                @click="handleDelete1(scope.row.videoId)"
                >删除</el-button
              >
            </template>
          </el-table-column>
        ...
        >
          <el-form :model="form1" ref="form1" label-width="80px">
            ...
            <el-form-item prop="videoTitle" label="稿件标题" size="mini">
              <el-input v-model="form1.videoTitle" placeholder="稿件标题"></el-input>
            </el-form-item>
            <el-form-item label="描述" size="mini">
              <el-input
            ...
            <el-form-item prop="videoLabel" label="标签" size="mini">
              <el-input v-model="form1.videoLabel" placeholder="标签"></el-input>
            </el-form-item>
            ...
            <el-form-item prop="videoShare" label="分享量" size="mini">
              <el-input v-model="form1.videoShare" placeholder="分享量"></el-input>
            </el-form-item>
          ...
          <span slot="footer">
            <el-button size="mini" @click="viewVisible1 = false">关闭</el-button>
          </span>
        </el-dialog>
        ...
        >
          <div align="center">删除后恢复不了了，是否确定删除</div>
          <span slot="footer">
            <el-button size="mini" @click="delVisible1 = false">取消</el-button>
            <el-button size="mini" @click="deleteRow1">确定</el-button>
          </span>
        </el-dialog>
      </div>
    </el-tab-pane>
...
<script>
import { getAllArticle, delArticle,getAllVideo, delVideo, getUserOfId } from "../api/index";
  ...
  methods: {
    ...
    getDate() {
      ...
      getAllArticle().then(res => {
        ...
        // this.tableData = res;
        for (let item of res) {
          this.getUsers(item.userId, item); //获取用户名，连同本对象一起放到tempDate和tableDate里面
        }
        this.currentPage = 1;
      });
    },
    ...
    getDate1() {
      ...
      getAllVideo().then(res => {
        ...
        // this.tableData = res;
        for (let item of res) {
          this.getUsers1(item.userId, item); //获取用户名，连同本对象一起放到tempDate和tableDate里面
        }
        this.currentPage1 = 1;
      });
    },
