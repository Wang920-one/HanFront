            ...
            <el-main>
              <div>
                <div>
                  ...
                  <div
                    style="width:80%;float:right;margin-right:10%;background-color:#ffffff50"
                  >
                    <!-- 专栏展示 -->
                    <div
                    ...
                    <div style="width:25%;margin-right:5%;float:right">
                      <el-card
                        style="background-color:#ffffff00;border-color:#ffffff00;box-shadow:none"
                      >
                        <!-- 关注作者 -->
                        ...
                        >
                          <el-card
                            style="height:90px;width:100%;background-color:#ffffff00;cursor: pointer;"
                          ...
                          >
                            ...
                            >
                              ...
                              <br />
                              <span style="font-size:15px"
                                >发布时间：{{ attachDate(item.atcTime) }}</span
                              >
                  ...
                  <!-- 专栏详情界面 -->
                  <div
                    style="margin-left:10%;margin-right:10%;height:20%;margin-top:30%;"
                  >
                    <hr />
                    <div>
                      <div class="dianzan_switch" style="float:left">
                        <el-button
                      ...
                      <!-- <div style="margin-left:2%;float:left">
                        <el-button
                          ...
                          circle
                          >{{ tempList.actShare }} 分享</el-button
                        >
                      </div> -->
                      <div style="margin-left:2%;float:left">
                        <el-button
                    ...
                    <div>
                      ...
                      <span
                        >{{ user.userName }}
                        {{ attachDate(tempList.atcTime) }}</span
                      ><br />
                  ...
                  <!-- 评论 -->
                  <comment :playId="articleid" :type="1"></comment>
                </div>
              </div>
            </el-main>
          </el-container>
