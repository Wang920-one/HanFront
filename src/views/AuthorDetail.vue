            ...
            <div class="album-content">
              ...
              <div class="content">
                <el-tabs type="border-card" v-model="activeName">
                  <el-tab-pane class="Arti" label="专栏" name="article">
                    <h1 class="title">
                  ...
                  <el-tab-pane class="Vide" label="视频" name="video">
                    <h1 class="title">
                      <slot name="title"></slot>
                      <hr />
                    </h1>
                    <ul>
                      ...
                      <li v-for="(item, index) in videolist" :key="index">
                        <div class="video-item" @click="goAlbum1(item)">
                          <span class="item-index">
                            {{ index + 1 }}
                          </span>
...
import { getUserOfId, getArticleOfUseId, getVideoOfUseId,getListOfSubscribe } from "../api/index";
export default {
  name: "author-detail",
  mixins: [mixin],
  data() {
