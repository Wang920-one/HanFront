          ...
          <el-container style="">
              ...
              <div>
                ...
                <div style="width:40%;float:left;font-size:20px">
                  <div>
                    ...
                    ></el-avatar> -->
                    <div class="user-img" style="margin-left:20%;float:left;">
                      <img
                    ...
                    <el-row
                      style="margin-left:20%;float:left;font-family:'楷体'"
                    >
                      <el-col>
                ...
                <div
                  style="width:50%;float:right;font-family:'楷体';font-size:20px"
                >
                  <div style="float:left;" @click="changeActiveNamez">
            ...
            <el-main>
              ...
              >
                  ...
                  <div>
                    <div style="text-align:left">
                      ...
                      >
                        ...
                        <el-form-item label="头像" width="110" align="left">
                          <template>
                            <div class="user-img">
                              <img
                                :src="attachImageUrl(this.userDate.userImage)"
                            ...
                            >
                              <el-button size="mini" round>更换头像</el-button>
                            </el-upload>
                          </template>
                        </el-form-item>
                        <el-form-item
                        ...
                        <el-form-item prop="userSex" label="性别" align="left">
                        ...
                        <el-form-item label="地区" align="left">
                          <v-distpicker
                            @selected="selected"
                ...
                <el-tab-pane label="稿件管理" name="article">
                  <el-tabs
                    v-model="activeName"
                    style="padding-top: 15px;line-height: 35px;"
                  >
                    <el-tab-pane label="视频" name="two1">
                      <div>
                        <div v-show="videoDate.length == 0" align="center">
                          <span>
                            你还没有发布视频哦
                          </span>
                        </div>
                          ...
                          >
                            <div>
                              ...
                              >
                                ...
                                <div
                                  style="padding: 10px;float:right;margin-top:20px"
                                >
                    ...
                    <el-tab-pane label="专栏" name="two2">
                      <div>
                        <div v-show="articleDate.length == 0" align="center">
                          <span>
                            你还没有发布专栏哦
                          </span>
                        </div>
                    ...
                    <el-tab-pane label="我的收藏" name="two3">
                      <div>
                        <div v-show="collectDate.length == 0" align="center">
                          <span>
                            你暂时没有收藏的作品哦
                          </span>
                        </div>
                            ...
                            <div>
                              ...
                              >
                                <div @click="goDetails(item, item.type)">
                                  ...
                                  />
                                  <div
                                    style="padding: 10px;float:left;weight:100%"
                                  >
                                    <span
                                      >标题：{{
                                ...
                                <div
                                  style="padding: 10px;float:right;margin-top:40px"
                                >
                                  <el-button
                                    size="mini"
                                    type="danger"
                    ...
                    >
                      ...
                      <span slot="footer">
                        <el-button size="mini" @click="delVisible1 = false"
                          >取消</el-button
                        >
                        <el-button size="mini" type="danger" @click="udelVideo"
                          >确定</el-button
                        >
                      </span>
                    </el-dialog>
                    ...
                    >
                      ...
                      <span slot="footer">
                        <el-button size="mini" @click="delVisible2 = false"
                          >取消</el-button
                        >
                        <el-button
                          size="mini"
                    ...
                    >
                      ...
                      <span slot="footer">
                        <el-button size="mini" @click="delVisible3 = false"
                          >取消</el-button
                        >
                        <el-button
                          size="mini"
                ...
                <el-tab-pane label="好友管理" name="friend">
                  <el-tabs
                    v-model="activeName1"
                    style="padding-top: 15px;line-height: 35px;"
                  >
                    <el-tab-pane label="我的关注" name="three1">
                      <div>
                        <div v-show="guanzDate.length == 0" align="center">
                          <span>
                            你暂时没有关注任何人哦
                          </span>
                        </div>
                        <el-col>
                          ...
                          >
                            ...
                            >
                              ...
                              <div
                                style="padding: 10px;float:right;margin-top:10px"
                              >
                                <el-button
                                  size="mini"
                                  type="danger"
                    ...
                    >
                      ...
                      <span slot="footer">
                        <el-button size="mini" @click="delVisible4 = false"
                          >取消</el-button
                        >
                        <el-button
                          size="mini"
                    ...
                    <el-tab-pane label="粉丝列表" name="three2">
                      <div>
                        <div v-show="fansDate.length == 0" align="center">
                          <span>
                            暂时没有粉丝关注你哦
                          </span>
                        </div>
                        ...
                        <el-col>
                          ...
                          >
                            ...
                            >
                              ...
                              />
                              <div
                                style="padding-left: 10px;float:left;weight:100%"
                              >
                                <span>昵称：{{ item.userName }}</span
                                ><br />
                                <span
                                  >被关注时间：{{ attachDate(item.time) }}</span
                                >
                                <div
                                  class="bottom clearfix"
                                  style="float:right"
