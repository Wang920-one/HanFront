      ...
      <el-header>
        ...
        <div v-show="!loginIn">
          <router-link to="/login">
            <el-tooltip content="去登陆注册" placement="bottom" effect="light">
              <el-button
                type="primary"
        ...
        <div v-show="loginIn">
          <el-dropdown class="manage-name" @command="hadleCommand">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              >
              <el-dropdown-item command="myMessage" icon="el-icon-message">
                我的消息</el-dropdown-item
              >
              <el-dropdown-item command="logout" icon="el-icon-warning-outline">
                退出登录</el-dropdown-item
              >
            </el-dropdown-menu>
          </el-dropdown>
          <img class="userAvator" :src="attachImageUrl(userImage)" />
          <router-link to="/publishvideo">
            <el-tooltip content="发布视频" placement="bottom" effect="light">
              <el-button
                type="primary"
                icon="el-icon-camera"
                class="shouye"
          ...
          <router-link to="/publish">
            <el-tooltip content="发布专栏" placement="bottom" effect="light">
              <el-button
                type="primary"
                icon="el-icon-edit"
                class="shouye"
        ...
        <div style="background-color: #f7a7a7;margin-top: 10px;">
          <span
            style="color:#fff;font-family:'楷体';font-size:18px;float:left;margin-left:15px;margin-top:15px"
            >华夏衣裳汉服交流网</span
          >
          <div
            class="header-search"
        ...
        <div>
          <div style="text-align:center;height:25px;">
            <el-button
              ...
              icon="el-icon-back"
            ></el-button>
            <h4 style="font-family:'楷体';font-size:25px">我的消息</h4>
          </div>
          <!-- 分割线 -->
